...
interface InputSingleFileVariants extends VariantProps<typeof inputSingleFileVariants>, Omit<React.ComponentProps<'input'>, 'size'> {
...
export default function InputSingleFile({form, size, error, allowedExtensions, maxFileSizeInMB, replaceBy, ...props}: InputSingleFileVariants) {
             ...
             {!formFile || !isValidFile() ? (
                <>
                   <div className="w-full relative group cursor-pointer">
                        <input type="file" className={`absolute top-0 right-0
                            w-full h-full opacity-0 cursor-pointer`} {...props}
                        />
                    ...
                    <div className="flex flex- col gap-1 mt-1">
                        ...
                        {formFile && !isValidSize() &&
                            <Text variant="label-small" className="text-accent-red">
                                O tamanho do arquivo ultrapassa o limite
                            </Text>
                        }
                ...
                <>
                    ...
                    <div className={`flex gap-3 items-center border boder-solid 
                        border-border-primary mt-5 p-3 rounded`}>
